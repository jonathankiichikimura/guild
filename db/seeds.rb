...
quest_data = [
  {
    ...
    category: "groceries", suburb: "Nakameguro", reward_amount: 1500, reward_type: "yen",
  ...
  },
  {
    ...
    category: "gardening", suburb: "Nakameguro", reward_amount: 2000, reward_type: "yen",
  ...
  },
  {
    ...
    category: "tech_help", suburb: "Meguro", reward_amount: 2500, reward_type: "yen",
    expires_at: 3.days.from_now, status: "in_progress", accepter: accepter_records[0]
  },
  {
    giver: giver_records[1],
    ...
    category: "transport", suburb: "Meguro", reward_amount: 3000, reward_type: "yen",
    expires_at: 1.week.from_now, status: "open"
  },
  {
    ...
    category: "household", suburb: "Shibuya", reward_amount: 1000, reward_type: "yen",
    expires_at: 5.days.from_now, status: "completed", accepter: accepter_records[1]
  },
  {
    giver: giver_records[2],
    ...
    category: "tech_help", suburb: "Shibuya", reward_amount: 1500, reward_type: "yen",
    expires_at: 4.days.from_now, status: "open"
  },
  {
...
if completed_quest&.accepter
  Review.find_or_create_by!(quest: completed_quest, giver: completed_quest.giver, accepter: completed_quest.accepter) do |r|
    r.rating = 5
